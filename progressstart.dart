...
class StatusStartedScreen extends StatefulWidget {
  const StatusStartedScreen({super.key});

  @override
  State<StatusStartedScreen> createState() => _StatusCompletedScreenState();
}

class _StatusCompletedScreenState extends State<StatusStartedScreen> {
  File? _image;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () {},
              child: Text("START THE JOURNEY", style: TextStyle(fontSize: 18)),
            ),
            SizedBox(height: 20),
          ],
        ),
